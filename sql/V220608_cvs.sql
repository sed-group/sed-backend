...
(
    ...
    `flow_start_time`       DECIMAL(20, 5) NULL,
    `flow_time`             DECIMAL(20, 5) NOT NULL,
    `interarrival_time`     DECIMAL(20, 5) NOT NULL,
    `start_time`            DECIMAL(20, 5) NOT NULL,
    `end_time`              DECIMAL(20, 5) NOT NULL,
    `discount_rate`         DECIMAL(20, 5) NOT NULL,
