...
def create_response_surface(data: DataFrame, output_cols, drop_cols=None) -> (List[float], List[str], List[float]):
    """
    ...
    x_train, x_test, y_train, y_test = train_test_split(polynomial_input_set, output_set, test_size=0.20)
