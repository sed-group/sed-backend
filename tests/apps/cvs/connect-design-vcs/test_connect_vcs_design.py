...
def test_delete_formulas_invalid_project(client, std_headers, std_user):
  ...
  res = client.delete(f'/api/cvs/project/{invalid_proj_id}/vcs-row/{formulas[0].vcs_row_id}/design-group/{formulas[0].design_group_id}/formulas',
                    headers=std_headers)
...
def test_delete_formulas_invalid_vcs_row(client, std_headers, std_user):
  ...
  #Act
  formulas = tu.seed_random_formulas(project.id, vcs.id, design_group.id, current_user.id, 1)
  invalid_vcs_row_id = formulas[0].vcs_row_id

  res = client.delete(f'/api/cvs/project/{project.id}/vcs-row/{invalid_vcs_row_id}/design-group/{formulas[0].design_group_id}/formulas',
                    headers=std_headers)
...
def test_delete_formulas_invalid_design_group(client, std_headers, std_user):
  ...
  res = client.delete(f'/api/cvs/project/{project.id}/vcs-row/{formulas[0].vcs_row_id}/design-group/{invalid_dg_id}/formulas',
                    headers=std_headers)
